<!-- views/orders/index.view.php -->
<h1>Pasūtījumu/Darījumu Skats</h1>

<h2>Kas notiek ar produktiem</h2>
<table>
    <tr><th>Nosaukums</th><th>SKU</th><th>Atlikums</th><th>Atrašanās vieta</th><th>Pēdējais atjauninājums</th></tr>
...
<ul>
    <?php foreach ($data['low_stock'] as $item): ?>
        <li><?php echo $item['name']; ?> (SKU: <?php echo $item['sku']; ?>) - Atlikums: <?php echo $item['quantity']; ?></li>
    <?php endforeach; ?>
</ul>
